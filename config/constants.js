...
module.exports.USERNAME_DUPLICATED = `Cannot use an existed username`;
...
module.exports.INVALID_PASSWORD = `Invalid password`;
module.exports.CHECK_USER_ERROR = `Can't check if the user is available`;
module.exports.REFRESH_TOKEN_OK = `Refresh token generated successful`;
module.exports.REFRESH_TOKEN_FAILED = `Refresh token generated unsuccessful`;
...
module.exports.SERVER_HTTP_REQUEST_FORBIDEN = 403;
...
module.exports.USER_LOGOUT_FAILED = `User logout unsuccessful.`;
...
module.exports.TOKEN_NOT_FOUND = "token can't be empty";
